...
Vagrant::Config.run do |config|
	...
	config.vm.box_url = "file:///Users/admin/Desktop/vagrant-django-base-master/django-base-v2.1.box"  # Torchbox-internal URL to django-base.box
	...
	config.vm.share_folder "project", "/home/vagrant/djangoember", "."
	
	# Enable provisioning with a shell script.
	config.vm.provision :shell, :path => "etc/install/install.sh", :args => "djangoember"
end
